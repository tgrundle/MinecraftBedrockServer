...
$SCREEN_CMD -Rd servername -X stuff "say Server is restarting in 30 seconds! $(printf '\r')"
sleep 23s
$SCREEN_CMD -Rd servername -X stuff "say Server is restarting in 7 seconds! $(printf '\r')"
sleep 1s
$SCREEN_CMD -Rd servername -X stuff "say Server is restarting in 6 seconds! $(printf '\r')"
sleep 1s
$SCREEN_CMD -Rd servername -X stuff "say Server is restarting in 5 seconds! $(printf '\r')"
sleep 1s
$SCREEN_CMD -Rd servername -X stuff "say Server is restarting in 4 seconds! $(printf '\r')"
sleep 1s
$SCREEN_CMD -Rd servername -X stuff "say Server is restarting in 3 seconds! $(printf '\r')"
sleep 1s
$SCREEN_CMD -Rd servername -X stuff "say Server is restarting in 2 seconds! $(printf '\r')"
sleep 1s
$SCREEN_CMD -Rd servername -X stuff "say Server is restarting in 1 second! $(printf '\r')"
sleep 1s
$SCREEN_CMD -Rd servername -X stuff "say Closing server...$(printf '\r')"
